  ...
  render() {
    return (
      ...
      <div>
        ...
        <Routes>
        <Route exact path="/dailynews" element={<News key = "dailynews" pageSize={6} country="in" category = 'general'/>}></Route>
        <Route exact path="/" element={<News key = "root" pageSize={6} country="in" category = 'general'/>}></Route>  
